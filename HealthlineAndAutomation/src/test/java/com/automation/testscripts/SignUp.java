...
public class SignUp {
	...
	public void invalidSignUp(String emailAddress) {
		...
		Assert.assertEquals(driver.findElement(By.id("create_account_error")).isDisplayed(), true,"Through invalid email address we are able to create an account.");
	}
	 ...
	 */
	 ...
	 @Test(dataProvider="emailIdExists",priority=2,description =
	 "Provide already exists email and check the functionality") public void
	 emailIdExits(String emailAddress) { signUp.createAnAccount(emailAddress);
